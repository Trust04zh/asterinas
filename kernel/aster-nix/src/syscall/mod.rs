...
define_syscall_nums!(
    ...
    SYS_TIME = 1022,
    SYS_FUTEX = 422,
    SYS_EPOLL_CREATE = 1023,
    SYS_GETDENTS64 = 61,
    SYS_SET_TID_ADDRESS = 96,
    SYS_CLOCK_GETTIME = 113,  // 403?
    SYS_CLOCK_NANOSLEEP = 407,
    SYS_EXIT_GROUP = 94,
    SYS_EPOLL_WAIT = 22, // pwait
    SYS_EPOLL_CTL = 21,
    SYS_TGKILL = 131,
    SYS_WAITID = 95,
    SYS_OPENAT = 56,
...
impl SyscallArgument {
    fn new_from_context(context: &UserContext) -> Self {
        ...
        #[cfg(target_arch = "riscv64")]
        let syscall_number = context.a7() as u64;
        let args = context.syscall_args().map(|arg| arg as u64);
        Self {
            syscall_number,
            args,
        }
...
pub fn syscall_dispatch(
    ...
    let ret = match syscall_number {
        ...
        SYS_GETPGID => syscall_handler!(1, sys_getpgid, args),
